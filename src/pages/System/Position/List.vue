<template>
    <div>
        ...
        <el-dialog title="新增职位" :visible.sync="dialogPositionAdd">
            <PositionAdd v-on:changeDialog="changeDialogPositionAdd"></PositionAdd>
        </el-dialog>
    </div>
</template>
...
export default {
    ...
    methods: {
        ...
        changeDialogPositionAdd(val) {
            this.dialogPositionAdd = val
        }
    }
}
</script>
