<template>
    <div>
        <el-card>
            <div slot="header" class="clearfix">
                ...
                <el-button-group style="float: right;">
                    ...
                    <el-button size="mini" type="success" @click="dialogColdConfig = true" icon="el-icon-setting">冷盘设置</el-button>
                </el-button-group>
            </div>
        ...
        <el-dialog v-if="dialogColdConfig" title="冷盘设置" :visible.sync="dialogColdConfig" append-to-body width="500px">
            <ColdConfig @closeDialog="closeDialog"></ColdConfig>
        </el-dialog>
...
import ColdConfig from './ColdConfig'
